...
function createRing(numSides, width, height, orient, figure) {
  ...
  var pieces = [figure];
  vector = (orient === "hor") ? multiply(1 / height, subtract(joint[1], joint[0])) : multiply(1 / width, subtract(joint[1], joint[0]));
